-- ==========================================
-- Migration 007: 為 RPC 加入 fiscal_year 篩選支援
-- 最後更新：2026-03-17
-- ==========================================

-- 1) 重建 match_chunks：加入 filter_fiscal_year 參數
...
-- 2) 重建 match_chunks_hybrid：加入 filter_fiscal_year 參數
DROP FUNCTION IF EXISTS match_chunks_hybrid;
